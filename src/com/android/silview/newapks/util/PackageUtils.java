package com.android.silview.newapks.util;

import java.io.File;
import java.util.List;

import com.android.silview.newapks.util.ShellUtils.CommandResult;
...
public class PackageUtils {
     ...
     * @return 0 
     */
    public static int getAppVersionCodeByName(Context context, String packageName) {
    	PackageManager pm = context.getPackageManager();
    	try {
    ...
    /**
     * get app version by apk path
     * @param context
     * @param apkPath apk path
     * @return
     */
    public static int getAppVersionCodeByPath(Context context, String archivePath) {
    	PackageManager pm = context.getPackageManager();
    	PackageInfo info = pm.getPackageArchiveInfo(archivePath, PackageManager.GET_ACTIVITIES);
    	if (info != null) {
    		ApplicationInfo appinfo = info.applicationInfo;
    		/*versioncode : update, versionName display to User*/
